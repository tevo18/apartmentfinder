...
from myhouse.models import home
from django.shortcuts import render_to_response
from django.views.decorators.csrf import csrf_exempt
from rest_framework_xml.parsers import XMLParser
from rest_framework_xml.renderers import XMLRenderer
from myhouse.serializers import homeSerializer
...
def index(request):
    ...
    return render_to_response('myhouse/index.html', {"homes": homes})


def detail(request, pk):
    home_detail = get_object_or_404(home, pk=pk)
    return render(request, 'myhouse/detail.html', {'home_detail': home_detail})
